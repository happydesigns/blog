...
useSeoMeta({
  ...
  articlePublishedTime: () => post.value?.publishedAt ? new Date(post.value.publishedAt).toISOString() : post.value?.date ? new Date(post.value.date).toISOString() : void 0,
  articleModifiedTime: () => post.value?.updatedAt ? new Date(post.value.updatedAt).toISOString() : void 0
});
useHead({
